          ...
          <Card>
            <BlockStack gap="400">
              ...
              <InlineStack gap="300" wrap={false}>
                <Button variant="primary" url={buildEmbeddedUrl(`/admin/themes/current/editor?context=apps&activateAppId=${themeExtId}/${embedHandle}&target=newAppsSection/app-embed`)} external>Open Theme Editor</Button>
              </InlineStack>
            </BlockStack>
          </Card>
        </Layout.Section>
